...
struct Ingredient {
    ...
    // Print out a formatted description of the ingredients
    var description: String {
...
// Some test recipes to seed the app with
extension Recipe {
